...
```{r, echo = FALSE, results = FALSE}
fitme <- bpnme(Error.rad ~ Maze + Trial.type + (1 + Maze|Subject), Maps, its = 100)
```
...
The posterior samples of the circular slope variance can be obtained using the following code:
